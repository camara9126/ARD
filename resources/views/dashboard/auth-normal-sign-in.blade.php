...
<head>
    <title>SPI GestioPro - Page connexion</title>
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Votre Addresse Email</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        ...
                                        <div class="col-12">
                                            <div class="checkbox-fade fade-in-primary d-">
                                                <label>
                                                    ...
                                                    <span class="text-inverse">Souviens-toi de moi</span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <p class="text-inverse text-left"><a href="#"><b>Retour au Site</b></a></p>
                                        </div>
                                        <div class="col-md-2">
